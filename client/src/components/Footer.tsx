    ...
    <footer className="bg-gray-900 text-gray-300 border-t border-gray-800">
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li>
              ...
              >
                <svg
                  className="h-4 w-4 mr-2 text-blue-400 group-hover:translate-x-1 transition-transform"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
          ...
          {/* <div className="mt-6">
            ...
            <div className="flex">
              <input
                ...
                className="bg-gray-800 text-white px-3 py-2 rounded-l-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent w-full text-sm"
              />
      ...
      <div className="border-t border-gray-800 mt-8 py-6">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-center md:text-left text-sm text-gray-500 mb-4 md:mb-0">
          ...
          {/* <div className="flex items-center space-x-4">
            ...
            <div className="flex space-x-2">
              <div className="bg-white p-1 rounded-sm">
                ...
                >
                  <path
                    d="M21 5H3C1.9 5 1 5.9 1 7V17C1 18.1 1.9 19 3 19H21C22.1 19 23 18.1 23 17V7C23 5.9 22.1 5 21 5Z"
                    stroke="#4A5568"
                    strokeWidth="1.5"
                  />
                  <path d="M1 10H23" stroke="#4A5568" strokeWidth="1.5" />
                  <path
                    d="M6 15H4"
                    stroke="#4A5568"
                    strokeWidth="2"
              ...
              <div className="bg-white p-1 rounded-sm">
                ...
                >
                  ...
                  />
                  <path d="M1 10H23" stroke="#4A5568" strokeWidth="1.5" />
                  <circle cx="18" cy="15" r="1" fill="#4A5568" />
                </svg>
              </div>
              <div className="bg-white p-1 rounded-sm">
                <svg
