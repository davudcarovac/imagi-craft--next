...
export default async function watermarkFile(filePath, // Putanja do glavne slike
inputImgPath, // Putanja do slike za vodeni žig
outputPath, // Putanja za izlaznu sliku
compositeOptions // Pozicija vodenog žiga
) {
